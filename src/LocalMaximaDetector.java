...
public class LocalMaximaDetector{
    ...
    private transient final static int DEFAULT_CONNECTIVITY = 1; // 1 is means 8-neighborhood
    private transient String THRESHOLD;
    private transient String CONNECTIVITY;
    ...
    public Vector<Point> detectMoleculeCandidates(FloatProcessor image,float localThresholdValue) throws FormulaParserException {
//    	float localThresholdValue = (float) (FloatStatistics.getStatistics(image, Measurements.STD_DEV, null)).stdDev;
        //float localThresholdValue = Thresholder.getThreshold(threshold);  ÐÞ¸Ä
//        thresholdValue = localThresholdValue;
        return getMax8Candidates(image, localThresholdValue);
    }
